...
static int sequencer_gap_remove_exec(bContext *C, wmOperator *op)
{
  ...
  WM_event_add_notifier(C, NC_SCENE | ND_SEQUENCER, SEQ_get_ref_scene_for_notifiers(C));
...
static int sequencer_set_range_to_strips_exec(bContext *C, wmOperator *op)
{
  ...
  WM_event_add_notifier(C, NC_SCENE | ND_FRAME_RANGE, SEQ_get_ref_scene_for_notifiers(C));
